...
import { createFailedRecoveringProofError, createIncorrectSignerAddressError, createTokenExpiredError, createMalformedTokenError, createTokenCannotBeUsedYetError, } from '../../core/sdk-exceptions.js';
import { ecRecover } from '../../utils/ec-recover.js';
import { parseDIDToken } from '../../utils/parse-didt.js';
import { parsePublicAddressFromIssuer } from '../../utils/issuer.js';
